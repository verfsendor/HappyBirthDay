 ...
 */
public class SenceActivityFour extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(SenceActivityFour.this, ShowService.class);
        startService(intent);
        autoDrawTextView.setBg(true);//
        bindService(intent,mServiceConnection,Context.BIND_AUTO_CREATE);//%d东奕@256,#ffffff,40,0,50,50@%
        final String txt = "可爱的阿奕宝贝:%/n% 生日%happy%！想了很久很久还是不知道该送什么,东东准备了好多天,想来还是写个%app%吧,独家研制的会自己写字的,这个上面的每一个字都是我一个一个录数据到字体库里面再播放出来的.然后花费了好多脑细胞和两个周末和%10%几个午休和晚上的时间,祝我的阿奕永远开心快乐,东东会永远陪着你.";
                ...
                try {
                    ...
                    if(showService != null){
                        ...
                        showService.set(autoDrawTextView, txt, new DrawFinsih() {
                            @Override
                            public void finish() {
                                startActivity(new Intent(SenceActivityFour.this,SenceActivityThree.class));
                            }
                        });
                    }else {
                        Toast.makeText(SenceActivityFour.this,"尚未建立绑定",Toast.LENGTH_LONG).show();
                    }
    ...
    protected void onDestroy() {
        ...
        try {
            ...
            stopService(new Intent(SenceActivityFour.this,ShowService.class));
        } catch (Exception e) {
            Toast.makeText(SenceActivityFour.this,"请先绑定服务再执行解绑",Toast.LENGTH_LONG).show();
        }
    }
