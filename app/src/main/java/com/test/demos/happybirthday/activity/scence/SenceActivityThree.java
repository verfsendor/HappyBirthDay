 ...
 */
public class SenceActivityThree extends AppCompatActivity {
                ...
                try {
                    ...
                    if(showService != null){
                        ...
                        showService.set(autoDrawTextView, txt, new DrawFinsih() {
                            @Override
                            public void finish() {
                                startActivity(new Intent(SenceActivityThree.this,SenceActivity2.class));
                            }
                        });
                    }else {
                        Toast.makeText(SenceActivityThree.this,"尚未建立绑定",Toast.LENGTH_LONG).show();
                    }
    ...
    protected void onDestroy() {
        ...
        try {
            ...
            stopService(new Intent(SenceActivityThree.this,ShowService.class));
        } catch (Exception e) {
            Toast.makeText(SenceActivityThree.this,"请先绑定服务再执行解绑",Toast.LENGTH_LONG).show();
        }
    }
